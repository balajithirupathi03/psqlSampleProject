<?php
//echo 'create table india.details (UserId var,Name varchar,Gender varchar(1),MailId varchar,ContactNumber longint,Products array,Category varchar(1),Passsword varchar)';
