...
<body>
    <form method="post" name='accountCreateForm' onsubmit="createAccount(event);return false;">
        <table>
            ...
            <tr>
                <td>Account Type</td>
                <td> : <input type="radio" name="AccountType" value="b" checked> Buyer
                    <input type="radio" name="AccountType" value="s"> Seller </td>
            </tr>
            <tr>
                <td>Country</td>
                <td> : <input type="radio" name="country" value="india"> India
                    ...
                    <input type="radio" name="country" value="malaysia"> Malaysia </td>
            </tr>
            <tr>
                <td>Password </td>
                <td> : <input type="password" name="passsword" required></td>
            </tr>
            <tr>
